...
Item {
    ...
    ListView {
        ...
        model: ListModel {
            ListElement {
                question: qsTr("이 프로그램으로 인해 제제를 받을 수 있나요?")
            ...
            ListElement {
                ...
                answer: qsTr('롤에서 공식적으로 지원하는 API 및 OP.GG 크롤링 방식으로 연동됩니다. 자세한 내용은 <a href="https://github.com/kjm960725/OPGG_Add-on#opgg_add-on">[소스코드 링크]</a>를 참조하세요.')
            }
        }
    }
}
